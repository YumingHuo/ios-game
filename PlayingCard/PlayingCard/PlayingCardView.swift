...
class PlayingCardView: UIView {
    ...
    private lazy var upperLaftCornerLabel = createCornerLabel()
    ...
    override func layoutSubviews() {
        ...
        configCornerLabel(upperLaftCornerLabel)
        upperLaftCornerLabel.frame.origin = bounds.origin.offsetBy(dx: cornerOffset, dy: cornerOffset)
